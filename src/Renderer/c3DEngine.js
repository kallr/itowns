 ...
 * @param {object} [zone] - partial zone to render (zone x/y uses view coordinates)
...
c3DEngine.prototype.renderViewToRenderTarget = function renderViewToRenderTarget(view, target, zone) {
    ...
    // Don't use setViewport / setScissor after setting the renderTarget, because
    // they affect non-rendertarget rendering as well.
    // Instead set properties before calling setRenderTarget
